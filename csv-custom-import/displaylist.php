...
<html>
 ...
 <body>
  ...
  <br />
  <div class="container">
   <h1 class="font-weight-bold" align="center">Import Rubies</h1>
   <br />
...
<script>
 ...
 $(document).ready(function(){
  ...
  $('#sample_form').on('submit', function(event){
   ...
   $.ajax({
    url:"/wp-content/plugins/csv-custom-import/upload.php",
    method:"POST",
  ...
  function start_import()
  {
   ...
   $.ajax({
    url:"/wp-content/plugins/csv-custom-import/import.php",
    success:function()
    {
  ...
  {
   $.ajax({
    url:"/wp-content/plugins/csv-custom-import/process.php",
    success:function(data)
    {
